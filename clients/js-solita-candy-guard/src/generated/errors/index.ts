...
/**
 * NotEnoughTRZ: 'Not enough TRZ to pay for the mint'
 *
 * @category Errors
 * @category generated
 */
export class NotEnoughTRZError extends Error {
  readonly code: number = 0x1782;
  readonly name: string = 'NotEnoughTRZ';
  constructor() {
    super('Not enough TRZ to pay for the mint');
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, NotEnoughTRZError);
    }
  }
}

createErrorFromCodeLookup.set(0x1782, () => new NotEnoughTRZError());
createErrorFromNameLookup.set('NotEnoughTRZ', () => new NotEnoughTRZError());
