...
export class CgNotEnoughTRZError extends ProgramError {
  readonly name: string = 'NotEnoughTRZ';

  readonly code: number = 0x1782; // 6018

  constructor(program: Program, cause?: Error) {
    super('Not enough TRZ to pay for the mint', program, cause);
  }
}
codeToErrorMap.set(0x1782, CgNotEnoughTRZError);
nameToErrorMap.set('NotEnoughTRZ', CgNotEnoughTRZError);
